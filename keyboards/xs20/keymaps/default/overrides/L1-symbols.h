...
// Right
const key_override_t plus_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_MINUS, KC_PLUS);          // Not working
const key_override_t asterisk_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_SLASH, KC_ASTERISK);  // Not working
const key_override_t percent_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_EQUAL, KC_PERCENT);    // Not working
