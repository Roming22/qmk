...
combo_t key_combos[COMBO_COUNT] = {
  // Left Alpha
  [ESCAPE_COMBO_0] = COMBO(LTR0_LTM0_LTI0_combo, KC_ESCAPE),
  [BACKSPACE_COMBO_0] = COMBO(RTI0_RTM0_RTR0_combo, KC_BACKSPACE),
  [ESCAPE_COMBO_1] = COMBO(LTR1_LTM1_LTI1_combo, KC_ESCAPE),
  [BACKSPACE_COMBO_1] = COMBO(RTI1_RTM1_RTR1_combo, KC_BACKSPACE),
  [ESCAPE_COMBO_2] = COMBO(LTR2_LTM2_LTI2_combo, KC_ESCAPE),
  [BACKSPACE_COMBO_2] = COMBO(RTI2_RTM2_RTR2_combo, KC_BACKSPACE),
