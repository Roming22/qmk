...
const key_override_t ampersand_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_AMPERSAND, KC_EXCLAIM);
const key_override_t comma_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_COMMA, KC_SEMICOLON);
const key_override_t dollar_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_DOLLAR, KC_QUESTION);
